...
const translations = {
  ar: {
    ...
    quickSearch: 'بحث سريع عن الأدوية',
    pharmacyLocations: 'مواقع الصيدليات على الخريطة',
  ...
  fr: {
    ...
    quickSearch: 'Recherche rapide de médicaments',
    pharmacyLocations: 'Emplacements des pharmacies sur la carte',
